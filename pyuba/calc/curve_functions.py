...
def interpolate(profile):
    ...
    profile["interpolation_f"] = interp1d(
        interpolation_values["x"], interpolation_values["y"]
    )
    profile["interpolation_s"] = InterpolatedUnivariateSpline(
        interpolation_values["x"], interpolation_values["y"], k=1
    )
    return None
